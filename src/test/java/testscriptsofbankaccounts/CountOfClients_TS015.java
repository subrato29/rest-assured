...
public class CountOfClients_TS015 extends DriverScript{
		
	
			@Test
			public void test_01(){
					isTestCaseRunnable("TC015");
					...
					System.out.println("No of clients in bank : "+countOfClients);
					ReportEvent.testStepReport(testCaseName, "pass", "No of clients in bank : "+countOfClients);
